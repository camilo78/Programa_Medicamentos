            ...
            <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-2">
                <div class="card-header pb-0 text-left bg-transparent">
                    <img src="../assets/img/logo.png" class="w-50" alt="Secretaria de Salud logo">
                  <h3 class="font-weight-bolder text-info text-gradient">Programa de Medicamentos en casa</h3>
                  <p class="mb-0 small">Inicia sesión para acceder a tus medicamentos de forma cómoda y confiable.</p>
                </div>
                <div class="card-body">
